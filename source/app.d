...
Scene buildScene()
{
    ...
    scene.light = new SphericalLight(Vector(0, -4, 0), 0.2, Color.white, 20.0);
    ...
    foreach (i; 0 .. 10)
    {
        ...
        y = uniform(-2.0, 0.0),
        z = uniform(-4.0, -2.0);
        scene.objects ~= new SphereSceneObject(material, Vector(x, y, z), 0.2);
    }
    ...
    foreach (i; 0 .. 10)
    {
        ...
        y = uniform(0.0, 2.0),
        z = uniform(-4.0, -2.0);
        scene.objects ~= new SphereSceneObject(Material.matteWhite, Vector(x, y, z), 0.8);
    }
